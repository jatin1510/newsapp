      ...
      <>
        <div className="my-3">
          <div className="card" style={{ minHeight: "28rem" }}>
            <img src={imageUrl?imageUrl:"https://as1.ftcdn.net/v2/jpg/02/48/42/64/1000_F_248426448_NVKLywWqArG2ADUxDq6QprtIzsF82dMF.jpg"} className="card-img-top" alt="..." height='200px'/>
